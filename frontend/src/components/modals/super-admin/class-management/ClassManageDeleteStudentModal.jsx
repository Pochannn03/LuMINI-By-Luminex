...
export default function ClassManageDeleteStudentModal({ isOpen, onClose, studentData, onSuccess }) {
  ...
  const handleDelete = async (e) => {
    ...
    try {
      ...
      setWarningConfig({
        isOpen: true,
        title: "Delete Failed",
        message: error.response?.data?.msg || "Failed to delete student. Please try again later."
      });
    } finally {
      setLoading(false);
    }
  ...
  return createPortal(
    <>
      ...
      <div className="modal-overlay active flex justify-center items-center p-4 z-[9995]" id="deleteStudentModal" onClick={handleClose}>
        <form 
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-[20px] font-extrabold text-[#1e293b]">Delete Student Account</h2>
              </div>
              <button 
                type="button"
                onClick={handleClose}
            ...
            <div className="flex flex-col mb-6">
              <p className="text-[14.5px] text-[#475569] leading-relaxed mb-4">
                Are you sure you want to delete <strong>{studentName}</strong>? This action will remove their profile, enrollment status, and parent connection immediately.
              </p>
