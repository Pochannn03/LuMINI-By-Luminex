...
export default function ClassManageDeleteTeacherModal({ isOpen, onClose, teacherData, onSuccess }) {
  ...
  const handleDelete = async (e) => {
    ...
    try {
      ...
      setWarningConfig({
        isOpen: true,
        title: "Delete Failed",
        message: error.response?.data?.msg || "Failed to delete teacher. Please try again or check the console."
      });
    } finally {
      setLoading(false);
    }
  ...
  return createPortal(
    <>
      ...
      <div className="modal-overlay active flex justify-center items-center p-4 z-[9990]" id="deleteTeacherModal" onClick={handleClose}>
        <form 
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-[20px] font-extrabold text-[#1e293b]">Delete Teacher Account</h2>
              </div>
              <button 
                type="button"
                onClick={handleClose}
            ...
            <div className="flex flex-col mb-6">
              <p className="text-[14.5px] text-[#475569] leading-relaxed mb-4">
                Are you sure you want to delete <strong>{teacherName}</strong>? This action will remove their profile and access immediately.
              </p>
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] font-bold text-[#64748b] tracking-wide uppercase">
