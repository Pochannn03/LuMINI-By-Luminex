              ...
              <div className="card form-card">
                ...
                <div className="profile-form">
                  ...
                  {isEditingCredentials && passwordData.password && (
                    <div className="flex flex-col mb-4 pl-1 pr-1 animate-[fadeIn_0.3s_ease-out]" style={{ marginTop: '8px' }}>
                  ...
                  {isEditingCredentials && (
                    <div className="form-group" style={{ marginTop: '8px' }}>
                      ...
                      <div className="input-wrapper" style={{ position: 'relative' }}>
                        ...
                        <input type={showConfirmPassword ? "text" : "password"} name="confirmPassword" placeholder="••••••••" value={passwordData.confirmPassword} onChange={handlePasswordChange} />
