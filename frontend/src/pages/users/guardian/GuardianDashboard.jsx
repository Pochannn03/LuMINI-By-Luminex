// frontend/src/pages/users/guardian/GuardianDashboard.jsx

import React, { useState, useEffect } from "react";
import { Link } from 'react-router-dom';
import { useAuth } from '../../../context/AuthProvider';
import axios from 'axios';
import '../../../styles/user/parent/parent-dashboard.css'; // Reusing parent styles
          ...
          <div className="flex flex-col gap-6"> {/* Grid Left */}
            ...
            <div className="card action-card">
              ...
              <div className="quick-actions-list">
                ...
                {/* --- REMOVED: Guardian Management --- */}

                {/* ONLY PICKUP HISTORY REMAINS */}
